...
const HomeSlider = () => {
  ...
  return (
    <Slider {...settings} className="py-20">
      <div className="bg-gradient-to-br from-primary/70 to-transparent h-[calc(100vh-400px)] !flex !flex-col !items-center !justify-center space-y-10 rounded-3xl">
        <h2 className="text-6xl text-white font-semibold">ZYNORO Ecosystem</h2>
        <p className="text-2xl text-white font-medium px-20 text-center">
      ...
      <div className="bg-gradient-to-br from-primary/70 to-transparent h-[calc(100vh-400px)] !flex !flex-col !items-center !justify-center space-y-10 rounded-3xl">
        <h2 className="text-6xl text-white font-semibold">ZYNORO Solution</h2>
        <p className="text-2xl text-white font-medium px-20 text-center">
      ...
      <div className="bg-gradient-to-br from-primary/70 to-transparent h-[calc(100vh-400px)] !flex !flex-col !items-center !justify-center space-y-10 rounded-3xl">
        <h2 className="text-6xl text-white font-semibold">ZYNORO Mission</h2>
        <p className="text-2xl text-white font-medium px-20 text-center">
